...
function colorchange() {
  if (count == 0) {
    document.getElementById("pallet-copy").innerText = "copy"
...
function rgbCalc() {
  ...
  Colorcode = "#" + Colorcode
  div = document.getElementById("pallet-box")
  h1 = document.getElementById("pallet-text")
...
function copy() {
  ...
  document.getElementById("pallet-copy").innerText = "copied"
  input.parentNode.removeChild(input)
}


function colorcheck(){
  var checktext = document.getElementById("copy-pallet-text").value
  document.getElementById("copy-pallet-color").style.backgroundColor = checktext
}